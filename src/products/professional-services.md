...
proof:
  enabled: true
  title: "Proof That <span class='text-teal-400'>Elevate</span> Professional Services Deliver Results"
  sub: "Outcomes from organizations that paired clear strategy with disciplined execution."
  cards:
    - title: "Market Growth for Strategic Guidance"
      desc: "The Global Virtual CIO (vCIO) services market is projected to reach an estimated value of $11.8 billion by 2025."
      metrics:
    ...
    - title: "SME Needs"
      desc: "SMEs often lack the resources for a full-time, high-level IT leader, yet remain a major driver of vCIO demand."
      metrics:
      ...
      source: "Data Insights Market, 2025–2033 Analysis"
    - title: "IT Skills Gap"
      desc: "There will be 3.5 million unfilled cybersecurity jobs globally in 2024, increasing reliance on external experts for strategic leadership."
      metrics:
